...
var RDFStoreChildClient = require("./../src/rdfstore_child_client.js").RDFStoreChildClient;
var Store = require("./../../js-store/src/store.js").Store;

exports.testConnection1 = function(test) {
    new RDFStoreChildClient.RDFStoreClient(__dirname+"/../src/rdfstore_child.js", {}, function(success,connection) {
        test.ok(success);
        test.done();
    });
};
...
exports.testLoad2 = function(test) {
    new RDFStoreChildClient.RDFStoreClient("/Users/antonio/Development/Projects/js/rdfstore-js/src/js-connection/src/rdfstore_child.js", {}, function(success, connection) {
...
exports.testStoreConnection = function(test) {
    Store.connect(__dirname+"/../src/rdfstore_child.js", {}, function(success, connection) {
        test.ok(success);
