      ...
      function parse_Aggregate() {
        ...
        if (result119 !== null) {
          ...
          if (result120 !== null) {
            ...
            var result121 = result126 !== null ? result126 : '';
            if (result121 !== null) {
              if (input.substr(pos, 1) === "*") {
                var result125 = "*";
                pos += 1;
              ...
              if (result125 !== null) {
                var result122 = result125;
              } else {
                var result124 = parse_ConditionalOrExpression();
                if (result124 !== null) {
                  var result122 = result124;
                } else {
                  var result122 = null;;
                };
              }
              if (result122 !== null) {
                ...
                if (result123 !== null) {
                  var result118 = [result119, result120, result121, result122, result123];
                } else {
                  var result118 = null;
                  pos = savedPos6;
                }
