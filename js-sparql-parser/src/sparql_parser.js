...
SparqlParser.parser = sparql = sparql = (function(){
    ...
    parse: function(input) {
      ...
      function parse_Quads(context) {
        ...
        if (result1 !== null) {
          var result2 = [];
          var savedPos1 = pos;
          var result4 = parse_QuadsNotTriples(context);
          if (result4 !== null) {
            if (input.substr(pos, 1) === ".") {
              var result8 = ".";
              pos += 1;
            ...
            if (result5 !== null) {
              var result7 = parse_TriplesTemplate(context);
              var result6 = result7 !== null ? result7 : '';
              if (result6 !== null) {
      ...
      function parse_QuadsNotTriples(context) {
        ...
        if (result1 !== null) {
          ...
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              var result6 = parse_TriplesTemplate(context);
              var result4 = result6 !== null ? result6 : '';
              if (result4 !== null) {
                if (input.substr(pos, 1) === "}") {
                  var result5 = "}";
