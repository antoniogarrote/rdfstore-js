  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_BuiltInCall() {
        ...
        if (result193 !== null) {
          var result194 = [];
          var result202 = parse_WS();
          while (result202 !== null) {
            result194.push(result202);
            var result202 = parse_WS();
          }
          if (result194 !== null) {
            if (input.substr(pos, 1) === "(") {
            ...
            if (result195 !== null) {
              ...
              while (result201 !== null) {
                result196.push(result201);
                var result201 = parse_WS();
              }
              if (result196 !== null) {
                var result197 = parse_ConditionalOrExpression();
                if (result197 !== null) {
                  var result198 = [];
                  var result200 = parse_WS();
                  while (result200 !== null) {
                    result198.push(result200);
                    var result200 = parse_WS();
                  }
                  if (result198 !== null) {
                    if (input.substr(pos, 1) === ")") {
                    ...
                    if (result199 !== null) {
                      var result192 = [result193, result194, result195, result196, result197, result198, result199];
                    } else {
                      var result192 = null;
                      pos = savedPos15;
                    }
        ...
        if (result191 !== null) {
          ...
          if (result181 !== null) {
            var result182 = [];
            var result190 = parse_WS();
            while (result190 !== null) {
              result182.push(result190);
              var result190 = parse_WS();
            }
            if (result182 !== null) {
              if (input.substr(pos, 1) === "(") {
              ...
              if (result183 !== null) {
                ...
                while (result189 !== null) {
                  result184.push(result189);
                  var result189 = parse_WS();
                }
                if (result184 !== null) {
                  var result185 = parse_ConditionalOrExpression();
                  if (result185 !== null) {
                    var result186 = [];
                    ...
                    if (result186 !== null) {
                      ...
                      if (result187 !== null) {
                        var result180 = [result181, result182, result183, result184, result185, result186, result187];
                      } else {
                        var result180 = null;
                        pos = savedPos14;
                      }
          ...
          var result179 = result180 !== null
            ...
            : null;
          if (result179 !== null) {
            var result0 = result179;
          } else {
            var savedPos13 = pos;
            if (input.substr(pos, 11) === "LANGMATCHES") {
              var result163 = "LANGMATCHES";
              pos += 11;
            } else {
              var result163 = null;
              if (reportMatchFailures) {
            ...
            if (result163 !== null) {
              var result164 = [];
              var result178 = parse_WS();
              while (result178 !== null) {
                result164.push(result178);
                var result178 = parse_WS();
              }
              if (result164 !== null) {
                if (input.substr(pos, 1) === "(") {
                ...
                if (result165 !== null) {
                  var result166 = [];
                  var result177 = parse_WS();
                  while (result177 !== null) {
                    result166.push(result177);
                    var result177 = parse_WS();
                  }
                  if (result166 !== null) {
                    var result167 = parse_ConditionalOrExpression();
                    if (result167 !== null) {
                      var result168 = [];
                          ...
                          if (result170 !== null) {
                            ...
                            if (result171 !== null) {
                              ...
                              if (result172 !== null) {
                                ...
                                if (result173 !== null) {
                                  var result162 = [result163, result164, result165, result166, result167, result168, result169, result170, result171, result172, result173];
                                } else {
                                  var result162 = null;
                                  pos = savedPos13;
                                }
            ...
            var result161 = result162 !== null
              ? (function(e1, e2) {
                    ...
                    return ex;
              })(result162[4], result162[8])
              : null;
            if (result161 !== null) {
              var result0 = result161;
            } else {
              var savedPos12 = pos;
              if (input.substr(pos, 8) === "DATATYPE") {
                var result151 = "DATATYPE";
                pos += 8;
              } else {
                var result151 = null;
                if (reportMatchFailures) {
                ...
                if (result152 !== null) {
                  ...
                  if (result153 !== null) {
                    ...
                    while (result159 !== null) {
                      result154.push(result159);
                      var result159 = parse_WS();
                    }
                    if (result154 !== null) {
                      var result155 = parse_ConditionalOrExpression();
                      if (result155 !== null) {
                        var result156 = [];
                        var result158 = parse_WS();
                        ...
                        if (result156 !== null) {
                          ...
                          if (result157 !== null) {
                            var result150 = [result151, result152, result153, result154, result155, result156, result157];
                          } else {
                            var result150 = null;
                            pos = savedPos12;
                          }
