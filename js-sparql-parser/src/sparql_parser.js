  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_SolutionModifier() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result8 = parse_GroupClause();
        var result1 = result8 !== null ? result8 : '';
        if (result1 !== null) {
          var result7 = parse_HavingClause();
          var result2 = result7 !== null ? result7 : '';
          if (result2 !== null) {
            var result6 = parse_OrderClause();
            var result3 = result6 !== null ? result6 : '';
            if (result3 !== null) {
              var result5 = parse_LimitOffsetClauses();
      ...
      function parse_OrderClause() {
        ...
        if (result1 !== null) {
          ...
          if (result2 !== null) {
            var result4 = parse_OrderCondition();
            if (result4 !== null) {
              var result3 = [];
              while (result4 !== null) {
                result3.push(result4);
      ...
      function parse_OrderCondition() {
        ...
        if (result5 !== null) {
          var result6 = parse_BrackettedExpression();
          if (result6 !== null) {
      ...
      function parse_LimitOffsetClauses() {
        ...
        if (result6 !== null) {
          var result8 = parse_OffsetClause();
        ...
        if (result5 !== null) {
          ...
          var savedPos0 = pos;
          var result2 = parse_OffsetClause();
          if (result2 !== null) {
            var result4 = parse_LimitClause();
          ...
          if (result83 !== null) {
            ...
            if (result67 !== null) {
              ...
              if (result68 !== null) {
                ...
                if (result69 !== null) {
                  ...
                  while (result81 !== null) {
                    result70.push(result81);
                    var result81 = parse_WS();
                  }
                  if (result70 !== null) {
                    var result71 = parse_ConditionalOrExpression();
                    if (result71 !== null) {
                      var result72 = [];
                      var result80 = parse_WS();
                      while (result80 !== null) {
                        result72.push(result80);
                        var result80 = parse_WS();
                      }
                      if (result72 !== null) {
                        if (input.substr(pos, 1) === ",") {
                        ...
                        if (result73 !== null) {
                          var result74 = [];
                          var result79 = parse_WS();
                          while (result79 !== null) {
                            result74.push(result79);
                            var result79 = parse_WS();
                          }
                          if (result74 !== null) {
                            var result75 = parse_ConditionalOrExpression();
                            if (result75 !== null) {
                              var result76 = [];
                              var result78 = parse_WS();
                              while (result78 !== null) {
                                result76.push(result78);
                                var result78 = parse_WS();
                              }
                              if (result76 !== null) {
                                if (input.substr(pos, 1) === ")") {
                                ...
                                if (result77 !== null) {
                                  var result66 = [result67, result68, result69, result70, result71, result72, result73, result74, result75, result76, result77];
                                } else {
                                  var result66 = null;
                                  pos = savedPos6;
                                }
            ...
            var result65 = result66 !== null
              ? (function(e1, e2) {
                    ...
                    return ex;
              })(result66[4], result66[8])
              : null;
            if (result65 !== null) {
              var result0 = result65;
            } else {
              var savedPos5 = pos;
              if (input.substr(pos, 8) === "DATATYPE") {
                var result55 = "DATATYPE";
                pos += 8;
              } else {
                var result55 = null;
                if (reportMatchFailures) {
              ...
              if (result55 !== null) {
                ...
                if (result56 !== null) {
                  ...
                  if (result57 !== null) {
                    ...
                    while (result63 !== null) {
                      result58.push(result63);
                      var result63 = parse_WS();
                    }
                    if (result58 !== null) {
                      var result59 = parse_ConditionalOrExpression();
                      if (result59 !== null) {
                        var result60 = [];
                        var result62 = parse_WS();
                        while (result62 !== null) {
                          result60.push(result62);
                          var result62 = parse_WS();
                        }
                        if (result60 !== null) {
                          if (input.substr(pos, 1) === ")") {
                          ...
                          if (result61 !== null) {
                            var result54 = [result55, result56, result57, result58, result59, result60, result61];
                          } else {
                            var result54 = null;
                            pos = savedPos5;
                          }
                      ...
                      if (result46 !== null) {
                        ...
                        if (result47 !== null) {
                          ...
                          if (result48 !== null) {
                            ...
                            if (result49 !== null) {
                              var result42 = [result43, result44, result45, result46, result47, result48, result49];
                            } else {
                              var result42 = null;
                              pos = savedPos4;
                            }
                  ...
                  if (result31 !== null) {
                    ...
                    if (result32 !== null) {
                      ...
                      if (result33 !== null) {
                        ...
                        if (result34 !== null) {
                          var result35 = parse_ConditionalOrExpression();
                          if (result35 !== null) {
                            var result36 = [];
                            var result38 = parse_WS();
                            while (result38 !== null) {
                          ...
                          if (result22 !== null) {
                            ...
                            if (result23 !== null) {
                              ...
                              if (result24 !== null) {
                                ...
                                if (result25 !== null) {
                                  var result18 = [result19, result20, result21, result22, result23, result24, result25];
                                } else {
                                  var result18 = null;
                                  pos = savedPos2;
                                }
